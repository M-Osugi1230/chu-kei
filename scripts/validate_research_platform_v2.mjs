...
assert.equal(release.repository.sourceConfirmed,release.repository.companies);
assert.equal(release.repository.deepVerified,release.repository.production);
assert.equal(release.repository.deepVerified,0);
assert.equal(release.repository.reAuditPool,315);
assert.equal(release.repository.templateReviewRequired,2685);
assert.equal(release.repository.reAuditPool+release.repository.templateReviewRequired,release.repository.companies);
assert.equal(release.repository.structured,release.repository.reAuditPool);
assert.equal(release.repository.qualityDebt,release.repository.companies-release.repository.deepVerified);
assert.equal(release.repository.phase1Selected,50);
assert.equal(release.repository.phase2Queued,450);
assert.equal(release.repository.actualCompanies,72);
assert.equal(release.repository.actualRows,258);
