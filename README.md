...
3,000社すべてが、公式一次資料、資料公表日、具体的なPDFページ証跡、構造化分析、数値項目、進捗評価、一次レビュー、独立再検証の要件を満たしています。

今回の拡張では、最新JPX一覧から500社を追加し、複数資料比較で471社、2022年以降の資料に限定した再調査で23社、全公式PDF回復調査で2社が品質条件を通過しました。残った4社は2026年7月までに上場廃止となっていたため、公式理由付きアーカイブへ移し、シイエヌエス、日本農薬、ブリッジインターナショナルグループ、オートバックスセブンへ置き換えました。置換後4社も公式資料調査と二段階承認を通過しています。

完了監査は [`operations/source-research/SOURCE_COVERAGE_3000_COMPLETION_REPORT.md`](operations/source-research/SOURCE_COVERAGE_3000_COMPLETION_REPORT.md) を参照してください。
...
1. 3,000社の目標・実績接続を拡大し、定義差を安全に扱う
