...
const USER_AGENT = 'Mozilla/5.0 (compatible; Chu-kei official IR audit/5.6)';
...
quality.final3SelectedOfficialResearch = {
  version: 'final3-selected-official-research-v2',
  generatedAt: new Date().toISOString(),
  companies: report,
};
fs.writeFileSync(QUALITY_PATH, `${JSON.stringify(quality, null, 2)}\n`);
fs.writeFileSync(path.join(ROOT, 'artifacts', 'final3-selected-official-research-v2.json'), `${JSON.stringify(quality.final3SelectedOfficialResearch, null, 2)}\n`);
